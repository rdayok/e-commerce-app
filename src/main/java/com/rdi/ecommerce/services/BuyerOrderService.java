...
public interface BuyerOrderService {
    ...
    Object verifyCheckOutPayment(VerifyingCheckoutPaymentRequest verifyingCheckoutPaymentRequest) throws BuyerOrderNotFoundException, BuyerCannotVerifyPaymentOfBuyerOrderNotTheirsException;
}
